...
{
    const String waveTypeName = "RangedEnemyWave";
    ...
    public override IEnumerator ExecuteWave()
    {
        ...
        switch (difficulty)
        {
            ...
            default: // Very Hard / Scaled
                normalEnemyChance = 35  + (difficulty - 3) * 10; // Example scaling for difficulties > 2
                meleeEnemyChance = 6    + (difficulty - 3) * 2;
                slowEnemyChance = 25    + (difficulty - 3) * 5;
                rangeEnemyChance = 20   + (difficulty - 3) * 5;
                break;
        }
