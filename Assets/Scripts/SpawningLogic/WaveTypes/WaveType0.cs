    ...
    public override IEnumerator ExecuteWave()
    {
        ...
        switch (difficulty)
        {
            case 0: // Easy
                ...
                speedEnemyChance = 0;  // speedEnemy is not assigned in current spawn logic
                slowEnemyChance = 5;
                rangeEnemyChance = 0;  // rangeEnemy is not assigned in current spawn logic
                break;
            case 1: // Medium
        ...
        int totalEnemiesToSpawnThisWave = normalEnemyChance + speedEnemyChance + slowEnemyChance + rangeEnemyChance;
        int enemiesSpawnedThisWave = 0;

        Debug.Log($"WaveType0: Total enemies to spawn this wave: {totalEnemiesToSpawnThisWave}");
        ...
        while (enemiesSpawnedThisWave < totalEnemiesToSpawnThisWave)
        {
            ...
            for (int i = 0; i < spawnsPerLoop; i++)
            {
                ...
                int remainingSpeed = speedEnemyChance; // Not used
                int remainingSlow = slowEnemyChance;
                int remainingRange = rangeEnemyChance; // Not used
        ...
        Debug.Log($"WaveType0 finished spawning {enemiesSpawnedThisWave} enemies.");
    }
}